...
export default function OperatorKPIs(){
  ...
  async function loadKPIs(){
    ...
    const active = operators.filter(o=>o.ativo)
    ...
    <div className="kpiGrid">
      ...
      <div className="kpiCard kpi-total">
        <div className="kpiHeader">
          <span className="kpiLabel">Operadores Totais</span>
      ...
      <div className="kpiCard kpi-active">
        <div className="kpiHeader">
          <span className="kpiLabel">Operadores Ativos</span>
          <div className="kpiIcon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="kpiCard kpi-beginner">
        <div className="kpiHeader">
          <span className="kpiLabel">Iniciantes</span>
          <div className="kpiIcon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="kpiValue">{beginners}</span>
      </div>

      {/* KPI: DESENVOLVIMENTO */}
      <div className="kpiCard kpi-developing">
        <div className="kpiHeader">
          <span className="kpiLabel">Em Desenvolvimento</span>
          <div className="kpiIcon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <span className="kpiValue">{developing}</span>
      </div>

      {/* KPI: ESPECIALISTAS */}
      <div className="kpiCard kpi-expert">
        <div className="kpiHeader">
          <span className="kpiLabel">Especialistas</span>
          <div className="kpiIcon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="kpiCard kpi-instructor">
        <div className="kpiHeader">
          <span className="kpiLabel">Instrutores</span>
          <div className="kpiIcon">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
